...
\newcommand{\InternalCardBorder}[1]{
	...
	\draw[#1, thick, fill=#1, fill opacity=0.4] (0.5*\cardWidth-0.5*\cardMargin, \cardHeight-\cardMargin) circle (\valueCircleRadius);
	\draw[#1, thick, fill=#1, fill opacity=0.4] (0.5*\cardWidth+0.5*\cardMargin, \cardHeight-\cardMargin) circle (\valueCircleRadius);
	...
	\draw[#1, thick, fill=#1, fill opacity=0.4] (\cardWidth-\cardMargin, 0.5*\cardHeight) circle (\valueCircleRadius);
	...
	\draw[#1, thick, fill=#1, fill opacity=0.4] (\cardMargin, 0.5*\cardHeight) circle (\valueCircleRadius);
	\draw[#1, thick, fill=#1, fill opacity=0.4] (\cardMargin, 0.5*\cardHeight-\valueCircleRadius-0.6*\cardMargin) circle (\valueCircleRadius);
	\draw[#1, thick, fill=#1, fill opacity=0.4] (\cardMargin, 0.5*\cardHeight+\valueCircleRadius+0.6*\cardMargin) circle (\valueCircleRadius);
...
\newcommand{\costBarFirst}[2]{
	\draw[#1, thick, fill=#1, fill opacity=0.4]
	...
	\draw[#2, fill=#2, fill opacity=0.4]
...
\newcommand{\leftSecondaryAbility}[2]{
	\draw[#1]
		...
		\node [rotate=-90] at (1.5*\cardMargin+1.75*\primaryAbilityBoxHeight, 0.5*\cardHeight) {\tiny #2};
}
...
\newcommand{\rightSecondaryAbility}[2]{
	\draw[#1]
		...
		\node [rotate=90] at (\cardWidth-1.5*\cardMargin-1.75*\primaryAbilityBoxHeight, 0.5*\cardHeight) {\tiny #2};
}